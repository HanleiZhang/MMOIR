...
from utils.loss import InstanceLoss,ClusterLoss
...
class CCManager:
    ...
    def __init__(self, args, data, model):
        ...
        self.clustering_metrics = CLUSTERING_Metrics(args)
        self.criterion_instance = InstanceLoss(args.train_batch_size, self.instance_temperature, self.device) 
        self.criterion_cluster = ClusterLoss(self.num_labels, self.cluster_temperature, self.device) 
        ...
        for epoch in trange(int(args.num_train_epochs), desc="Epoch"):  
            ...
            for batch in tqdm(self.augdataloader, desc="Training(All)"):
                ...
                with torch.set_grad_enabled(True):
                    ...
                    z_i, z_j, c_i, c_j = self.model.model.get_features(x_i, x_j)
    ...
    def _test(self, args):
        ...
        test_results = self.clustering_metrics(y_true, y_pred)
