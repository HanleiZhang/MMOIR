...
class UMCManager:
    ...
    def __init__(self, args, data, model):
        ...
        self.device, self.model = model.device, pretrain_manager.model                   #model._set_model(args)
    ...
    def load_pretrained_model(self, pretrained_model):
        ...
        # mlp_params = ['model.mlp_head.2.weight', 'model.mlp_head.2.bias', 'model.classifier.weight', 'model.classifier.bias']
