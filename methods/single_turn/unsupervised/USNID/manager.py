...
class UnsupUSNIDManager:
    ...
    def __init__(self, args, data, model):
        ...
        self.device, self.model = model.device, pretrain_manager.model
    ...
    def load_pretrained_model(self, pretrained_model):
        ...
        classifier_params = ['model.classifier.weight', 'model.classifier.bias',
                            'model.mlp_head.weight', 'model.mlp_head.bias']
