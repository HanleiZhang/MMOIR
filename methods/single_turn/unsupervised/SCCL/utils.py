...
def _set_optimizer(args, model, train_dataloader):
    ...
    model.model.init_model(cluster_centers=cluster_centers, alpha=args.alpha) 
    optimizer = torch.optim.Adam([
        {'params':model.model.backbone.parameters()}, 
        {'params':model.model.contrast_head.parameters(), 'lr': args.lr * args.lr_scale},
        {'params':model.model.cluster_centers, 'lr': args.lr * args.lr_scale}
    ], lr = args.lr)
    return optimizer 
