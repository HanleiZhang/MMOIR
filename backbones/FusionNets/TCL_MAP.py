...
class MAP(BertPreTrainedModel):
    ...
    Return:
        ...
        _, aligned_acoustic,aligned_visual = self.alignNet(batch_ctx, acoustic, visual )
        ...
        generated_ctx = self.trans_a_with_l(batch_ctx.permute(1, 0, 2),aligned_acoustic.permute(1, 0, 2), aligned_visual.permute(1, 0, 2)).permute(1, 0, 2)
...
class TCL_MAP(nn.Module):
    def __init__(self, args):
        ...
        self.model = MAP_Model.from_pretrained(args.text_pretrained_model, args=args)
        self.cons_model = Cons_Model.from_pretrained(args.text_pretrained_model, args=args)
